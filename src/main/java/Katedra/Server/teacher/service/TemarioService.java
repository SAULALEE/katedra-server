package Katedra.Server.teacher.service;
...
import Katedra.Server.teacher.dto.TemarioStatsResponseDTO;
import Katedra.Server.teacher.model.Asignatura;
import Katedra.Server.teacher.model.ContenidoTemario;
import Katedra.Server.teacher.model.OrigenTemario;
import Katedra.Server.teacher.model.Temario;
import Katedra.Server.teacher.model.TipoEventoHistorial;
import Katedra.Server.model.Usuario;
import Katedra.Server.teacher.repository.AsignaturaRepository;
import Katedra.Server.teacher.repository.ContenidoTemarioRepository;
import Katedra.Server.teacher.repository.TemarioRepository;
