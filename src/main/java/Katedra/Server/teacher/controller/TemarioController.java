package Katedra.Server.teacher.controller;

import Katedra.Server.teacher.dto.TemarioRequestDTO;
import Katedra.Server.teacher.dto.TemarioResponseDTO;
import Katedra.Server.teacher.dto.TemarioUploadResponseDTO;
import Katedra.Server.teacher.dto.TemarioUrlRequestDTO;
import Katedra.Server.teacher.model.ModeloGeneracion;
import Katedra.Server.teacher.service.TemarioService;
...
public class TemarioController {
    ...
    private final Katedra.Server.teacher.service.ContenidoTemarioService contenidoTemarioService;
    private final Katedra.Server.teacher.service.HistorialEventoService historialEventoService;

    public TemarioController(
            TemarioService temarioService,
            Katedra.Server.teacher.service.ContenidoTemarioService contenidoTemarioService,
            Katedra.Server.teacher.service.HistorialEventoService historialEventoService) {
    ...
    public CompletableFuture<ResponseEntity<TemarioResponseDTO>> createTemario(
        ...
        var generationRequest = new Katedra.Server.teacher.dto.GenerarMaterialRequestDTO(
                Set.of(Katedra.Server.teacher.model.PiezaMaterial.ESTRUCTURA),
    ...
    public ResponseEntity<Katedra.Server.teacher.dto.TemarioStatsResponseDTO> getEstadisticas(Authentication authentication) {
    ...
    public ResponseEntity<List<Katedra.Server.teacher.dto.HistorialEventoResponseDTO>> getHistorial(Authentication authentication) {
    ...
    public ResponseEntity<TemarioResponseDTO> updateFavorito(
            @PathVariable String id,
            @Valid @RequestBody Katedra.Server.teacher.dto.TemarioFavoritoRequestDTO request,
            Authentication authentication) {
    ...
    public ResponseEntity<Katedra.Server.teacher.dto.ContenidoTemarioResponseDTO> getContenidoByTemarioId(
            @PathVariable String id,
            Authentication authentication) {
        String userEmail = authentication.getName();
    ...
    public ResponseEntity<Katedra.Server.teacher.dto.ContenidoFuenteResponseDTO> getFuenteByTemarioId(
            @PathVariable String id,
            Authentication authentication) {
        return ResponseEntity.ok(
    ...
    public CompletableFuture<ResponseEntity<Katedra.Server.teacher.dto.ContenidoTemarioResponseDTO>> generarMaterial(
            @PathVariable String id,
            @RequestBody Katedra.Server.teacher.dto.GenerarMaterialRequestDTO request,
            Authentication authentication) {
        String userEmail = authentication.getName();
    ...
    private Katedra.Server.teacher.model.ModeloIA resolveModeloGeneracion(ModeloGeneracion modeloGeneracion) {
        return modeloGeneracion == null
                ? Katedra.Server.teacher.model.ModeloIA.FLASH
