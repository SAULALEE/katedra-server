...
import Katedra.Server.teacher.service.ContenidoTemarioService;
...
class TemarioControllerTest {
    ...
    @MockitoBean
    private Katedra.Server.teacher.service.HistorialEventoService historialEventoService;
    ...
    void shouldCreateTemario() throws Exception {
        ...
        var generatedContent = new Katedra.Server.teacher.dto.ContenidoTemarioResponseDTO(
        ...
        given(contenidoTemarioService.generarMaterial(
                ...
                any(Katedra.Server.teacher.dto.GenerarMaterialRequestDTO.class)))
        ...
        verify(contenidoTemarioService).generarMaterial(
                ...
                org.mockito.ArgumentMatchers.argThat(request ->
                        request.piezas().equals(Set.of(PiezaMaterial.ESTRUCTURA))
                                && request.modelo() == Katedra.Server.teacher.model.ModeloIA.FLASH));
    }
    ...
    void shouldUploadTemarioFile() throws Exception {
        ...
        given(contenidoTemarioService.generarMaterial(
                ...
                .willReturn(CompletableFuture.completedFuture(
                        new Katedra.Server.teacher.dto.ContenidoTemarioResponseDTO(
                                "contenido-uuid-789", "temario-uuid-123", "## Estructura generada", null,
                                null, null, "basico", Map.of())));
        ...
        verify(contenidoTemarioService).generarMaterial(
                ...
                org.mockito.ArgumentMatchers.argThat(request ->
                        request.piezas().equals(Set.of(PiezaMaterial.ESTRUCTURA))
                                && request.modelo() == Katedra.Server.teacher.model.ModeloIA.PRO));
    }
    ...
    void shouldGetTemarioStatistics() throws Exception {
        given(temarioService.getEstadisticas("profesor@katedra.com"))
                .willReturn(new Katedra.Server.teacher.dto.TemarioStatsResponseDTO(7));
    ...
    void shouldGetHistorial() throws Exception {
        var evento = new Katedra.Server.teacher.dto.HistorialEventoResponseDTO(
                "evento-uuid-1", "temario-uuid-123", "Curso de Spring Boot", "Programación",
                Katedra.Server.teacher.model.TipoEventoHistorial.CREADO, null, LocalDateTime.now());
    ...
    void shouldGetContenidoByTemarioId() throws Exception {
        var contenidoResponse = new Katedra.Server.teacher.dto.ContenidoTemarioResponseDTO(
    ...
    void shouldGetOriginalSourceByTemarioId() throws Exception {
        var response = new Katedra.Server.teacher.dto.ContenidoFuenteResponseDTO(
    ...
    void shouldGenerarMaterialSelectivoAsync() throws Exception {
        ...
        var contenidoResponse = new Katedra.Server.teacher.dto.ContenidoTemarioResponseDTO(
                ...
                List.of(new Katedra.Server.teacher.dto.EvaluacionPreguntaDTO(
