...
import Katedra.Server.teacher.dto.HistorialEventoResponseDTO;
...
import Katedra.Server.teacher.repository.HistorialEventoRepository;
...
class HistorialEventoServiceTest {
    ...
    void shouldPersistASnapshotOfTheTemarioAtEventTime() {
        ...
        ArgumentCaptor<Katedra.Server.teacher.model.HistorialEvento> captor =
                ArgumentCaptor.forClass(Katedra.Server.teacher.model.HistorialEvento.class);
        verify(historialEventoRepository).save(captor.capture());

        Katedra.Server.teacher.model.HistorialEvento evento = captor.getValue();
    ...
    void shouldListHistoryNewestFirstForTheAuthenticatedUser() {
        Katedra.Server.teacher.model.HistorialEvento evento = new Katedra.Server.teacher.model.HistorialEvento(
