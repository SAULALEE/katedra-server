...
import Katedra.Server.teacher.dto.ContenidoTemarioResponseDTO;
import Katedra.Server.teacher.dto.DiapositivaDTO;
import Katedra.Server.teacher.dto.EvaluacionPreguntaDTO;
import Katedra.Server.teacher.dto.GenerarMaterialRequestDTO;
...
class ContenidoTemarioServiceTest {
    ...
    void shouldGenerateOnlyRequestedPiece() throws ExecutionException, InterruptedException {
        ...
        verify(historialEventoService).registrar(
                eq(mockTemario), eq(Katedra.Server.teacher.model.TipoEventoHistorial.GENERADO), anyString());
